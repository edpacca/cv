...
export const familiar: Skill = {title: "Familiar with", attributes: ["Python", "C", "Bash script", "K8s", "CDK", "Helm", "Terraform", "Svelte", "Netlify", "Gatsby"]}
export const aws: Skill = {title: "AWS Resources", attributes: ["EKS", "ECS", "S3", "EC2", "ECR", "DynamoDb", "CloudWatch"]}
